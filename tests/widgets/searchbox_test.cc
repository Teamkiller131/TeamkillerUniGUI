...
TEST_F(SearchBoxTest,Render_DoesNotCrash){unigui::SearchBox sb("sb");sb.SetItems({"Apple","Banana","Cherry"});sb.Render();}
TEST_F(SearchBoxTest,GetQuery_DefaultsEmpty){unigui::SearchBox sb("sb");EXPECT_EQ(sb.GetQuery(),"");}
