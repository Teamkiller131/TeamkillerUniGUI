...
TEST_F(BreadcrumbTest, Render_DoesNotCrash) { unigui::Breadcrumb bc("bc"); bc.SetItems({"Home","Settings"}); bc.Render(); }
TEST_F(BreadcrumbTest, GetSelected_DefaultsNegativeOne) { unigui::Breadcrumb bc("bc"); EXPECT_EQ(bc.GetSelected(), -1); }
