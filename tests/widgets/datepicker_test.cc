...
TEST_F(DatePickerTest, GetDate_Works) { unigui::DatePicker dp("dp","Date"); auto d=dp.GetDate(); EXPECT_EQ(d[0],2026); }
TEST_F(DatePickerTest, Render_DoesNotCrash) { unigui::DatePicker dp("dp","Date"); dp.Render(); }
