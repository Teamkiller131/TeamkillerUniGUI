...
TEST_F(DirPathTest, GetPath_DefaultsToEmpty) { unigui::DirPath dp("dp","Folder"); EXPECT_EQ(dp.GetPath(), ""); }
TEST_F(DirPathTest, Render_DoesNotCrash) { unigui::DirPath dp("dp","Folder"); dp.SetPath("C:\\test"); dp.Render(); }
