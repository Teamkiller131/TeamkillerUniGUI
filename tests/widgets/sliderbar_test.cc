...
TEST_F(SliderBarTest, SetTicks_WithData) {
    ...
    std::vector<unigui::SliderBar::Tick> ticks = {{10, 0.5}, {50, 0.75}, {80, 0.9}};
    sb.SetTicks(ticks);
...
TEST_F(SliderBarTest, GetActiveTickIndex_FindsMatch) {
    ...
    sb.SetTicks({{10, 100.5}, {20, 200.0}, {30, 300.75}});
...
TEST_F(SliderBarTest, OnChanged_FiresOnRender) {
    ...
    bool fired = false;
    sb.SetOnChanged([&](const std::vector<unigui::SliderBar::Tick>&) { fired = true; });
    sb.SetTicks({{10, 0.5}});
...
TEST_F(SliderBarTest, SetTickColors) {
    ...
    sb.SetTickColors({IM_COL32(0xFF, 0x00, 0x00, 0xFF), IM_COL32(0x00, 0xFF, 0x00, 0xFF),
...
TEST_F(SliderBarTest, FullConfig_RendersWithoutCrash) {
    ...
    sb.SetTickColors({IM_COL32(0xE9, 0x45, 0x60, 0xFF), IM_COL32(0x28, 0xA7, 0x45, 0xFF),
                      IM_COL32(0xF0, 0xC0, 0x40, 0xFF)});
    sb.SetTicks({{30, 4500.25}, {100, 4510.50}, {170, 4520.75}});
    bool changedFired = false;
    sb.SetOnChanged([&](const std::vector<unigui::SliderBar::Tick>&) { changedFired = true; });
    sb.SetOnAdd([]() {});
    sb.SetOnConfirm([]() {});
    sb.SetOnRollback([]() {});
    sb.SetOnSubmit([]() {});
