...
TEST_F(RichTextTest, Render_DoesNotCrash) { unigui::RichText rt("rt", "Hello"); rt.Render(); }
TEST_F(RichTextTest, SetSpans_Renders) { unigui::RichText rt("rt"); rt.SetSpans({{"Bold", true, false, ImVec4(1,1,1,1)}, {" Italic", false, true, ImVec4(1,0,0,1)}}); rt.Render(); }
