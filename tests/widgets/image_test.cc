...
TEST_F(ImageTest, Render_NoTexture_DoesNotCrash) { unigui::Image img("img"); img.Render(); }
TEST_F(ImageTest, Render_WithDummyTexture_DoesNotCrash) { unigui::Image img("img",(void*)1,100,100); img.Render(); }
