...
TEST_F(IconButtonTest, Render_DoesNotCrash) { unigui::IconButton ib("ib","★","Star"); ib.Render(); }
TEST_F(IconButtonTest, WasClicked_DefaultsFalse) { unigui::IconButton ib("ib","★"); EXPECT_FALSE(ib.WasClicked()); }
