...
class MultiLineTest : public ::testing::Test {
protected:
    void SetUp() override {
        ImGui::CreateContext();
...
TEST_F(MultiLineTest, Render_DoesNotCrash) {
    unigui::MultiLine ml("ml", "Line1\nLine2");
    ml.Render();
}
TEST_F(MultiLineTest, GetText_Works) {
    unigui::MultiLine ml("ml", "Hello");
    EXPECT_EQ(ml.GetText(), "Hello");
}
