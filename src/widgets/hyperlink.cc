...
#endif
namespace unigui {
Hyperlink::Hyperlink(std::string n, std::string l, std::string u):Widget(std::move(n)),label_(std::move(l)),url_(std::move(u)){}
void Hyperlink::SetURL(std::string u){url_=std::move(u);} void Hyperlink::SetLabel(std::string l){label_=std::move(l);}
