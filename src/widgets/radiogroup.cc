...
const std::vector<std::string>& RadioGroup::GetOptions() const { return options_; }
void RadioGroup::SetOnChange(std::function<void(int)> callback) { on_change_ = std::move(callback); }
}
