...
void Separator::Render(){if(!IsVisible())return; ImGui::PushID(GetName().c_str()); if(label_.empty())ImGui::Separator(); else ImGui::SeparatorText(label_.c_str()); ImGui::PopID();}
