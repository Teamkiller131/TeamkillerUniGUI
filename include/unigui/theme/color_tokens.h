...
inline const char* SemanticName(Semantic s) {
    switch (s) {
        case Semantic::Accent:  return "Accent";
        case Semantic::Success: return "Success";
        case Semantic::Warning: return "Warning";
        case Semantic::Danger:  return "Danger";
        case Semantic::Info:    return "Info";
    }
    return "Accent";
}
...
inline ImVec4 SemanticColor(const ColorTokens& t, Semantic s) {
    switch (s) {
        case Semantic::Accent:  return t.accent;
        case Semantic::Success: return t.success;
        case Semantic::Warning: return t.warning;
        case Semantic::Danger:  return t.danger;
        case Semantic::Info:    return t.info;
    }
    return t.accent;
}
...
inline ColorTokens g_active_color_tokens = DeriveColorTokens(
    ImVec4(0.40f, 0.58f, 0.93f, 1.00f), /*dark=*/true);
} // namespace detail

/// The colour tokens from the most recent ApplyColorTokens() call.
inline const ColorTokens& ActiveColorTokens() { return detail::g_active_color_tokens; }
...
inline const std::array<Semantic, 5>& AllSemantics() {
    static const std::array<Semantic, 5> kAll = {
        Semantic::Accent, Semantic::Success, Semantic::Warning,
        Semantic::Danger, Semantic::Info};
    return kAll;
}
