...
inline float Ease(float t, EasingCurve c = EasingCurve::Linear) {
    ...
    case EasingCurve::QuadOut:
        return quadOut(t);
    case EasingCurve::QuadInOut:
        return quadInOut(t);
    case EasingCurve::CubicIn:
        return cubicIn(t);
    case EasingCurve::CubicOut:
        return cubicOut(t);
    case EasingCurve::ExpoIn:
        return expoIn(t);
    case EasingCurve::ExpoOut:
        return expoOut(t);
...
inline EasingCurve ParseEasing(std::string_view name) {
    ...
    if (name == "quadIn")
        return EasingCurve::QuadIn;
    if (name == "quadOut")
        return EasingCurve::QuadOut;
    if (name == "quadInOut")
        return EasingCurve::QuadInOut;
    if (name == "cubicIn")
        return EasingCurve::CubicIn;
    if (name == "cubicOut")
        return EasingCurve::CubicOut;
    if (name == "expoIn")
        return EasingCurve::ExpoIn;
    if (name == "expoOut")
        return EasingCurve::ExpoOut;
    if (name == "elasticOut")
        return EasingCurve::ElasticOut;
    if (name == "bounceOut")
        return EasingCurve::BounceOut;
    // CSS aliases
    if (name == "ease")
        return EasingCurve::Ease;
    if (name == "ease-in")
